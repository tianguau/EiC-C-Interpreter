...
#define lltoa(x,y,z)    _lltoa(x,y,z,1)
#define ulltoa(x,y,z)	_lltoa(x,y,z,2)
#else
...
char *ulltoa(unsigned long long n, char *s, int radix);
char *lltoa(long long n, char *s, int radix);
#endif /* end EiC */
...
char * _ltoa(long int n,char *str, int radix, int mod);
char * _lltoa(long long int n,char *str, int radix, int mod);
