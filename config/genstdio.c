...
void crt_uinttypedef(FILE *fp, char *id, int sz)
{
   ...
   if(sizeof(unsigned char) == sz)       s = "unsigned char"; 
...
int do_limits(char *header)
{
    ...
    fprintf(fp,"#define INT64_MAX\t %lldLL\n", (long long) INT64_MAX);
    fprintf(fp,"#define UINT64_MAX\t %lluLL\n", (unsigned long long) UINT64_MAX);
    fprintf(fp,"#define INT64_MIN\t (-INT64_MAX-1)\n");
...
int do_termios(char *header)
{
    ...
    crt_uinttypedef(fp,"cc_t", sizeof( unsigned char /* cc_t */));
    crt_uinttypedef(fp,"speed_t", sizeof(unsigned int /* sizeof(speed_t) */));
	crt_uinttypedef(fp,"tcflag_t", sizeof(unsigned int /* tcflag_t */));  
